...
const Remarks3 = () => {
 ...
 <div className="h-full overflow-x-hidden  pt-4 grid lg:grid-cols-[1fr_2fr] bg-pink-300 items-center ">
      <div className="w-full px-10 h-[600px] relative flex items-center justify-center">
            ...
            <Image src={"/steph.svg"} alt="max image" width={150} height={100} className="z-10 md:left-42 object-contain pt-[100px] flex md:absolute"/>
...
<div className="w-full px-3 h-[300px] space-y-5 flex-col relative items-center justify-center text-center bg-pink-400/70 flex ">

<h1 className="text-5xl font-semibold tracking-wider"> Share your work. Someone out there needs it.  </h1>

<Link href={"/"}  className="flex lg:w-62 group relative w-full pt-6">
      
      <div className="w-full justify-center z-20 flex items-center p-4  text-muted-foreground   bg-yellow-400 transition-transform rounded-sm border border-muted-foreground">                 
      <h1 className="text-xl "> Start selling</h1>


 </div>
      <span className=" w-full justify-center text-center cursor-pointer z-30 p-4 flex items-center absolute  bg-black   text-white group-hover:-translate-y-2 group-hover:-translate-x-1 transition-transform rounded-sm border border-muted-foreground">
     <h1 className="text-xl  "> Start selling</h1>

         </span> 
         <span className="w-full justify-center z-10 cursor-pointer p-4 flex items-center absolute  bg-red-500   text-white group-hover:translate-y-2 group-hover:translate-x-1 transition-transform rounded-sm border border-muted-foreground">
     <h1 className="text-xl "> Start selling</h1>
