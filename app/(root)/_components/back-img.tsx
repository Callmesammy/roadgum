...
const BckImg = () => {
    return ( 
        <div className="flex w-full h-full relative overflow-hidden">
            <Image src="/001.png" alt="image" width={200} height={150} className="absolute top-40 left-30 transition-transform opacity-35 hidden md:flex  animate-bounce duration-1000 ease-in-out " />
            ...
            <Image src="/002.png" alt="image" width={200} height={150} className="absolute bottom-0 right-70  transition-transform opacity-75 animate-ping hidden md:flex  duration-1000 ease-in-out " />
