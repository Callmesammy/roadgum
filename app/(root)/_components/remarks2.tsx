...
const Remarks2 = () => {
    return (
      ...
      <div className="w-full px-10 h-[600px] relative flex items-center justify-center">
            ...
            <Image src={"/trend.webp"} alt="max image" fill  className="object-contain lg:pt-3 flex z-10 "/>
            <Image src={"/freetr.svg"} alt="max image" width={200} height={200} className="z-10 left-4 object-contain pt-[100px] flex lg:absolute"/>
