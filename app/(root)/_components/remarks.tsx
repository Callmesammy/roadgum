...
 <div className=" pt-4 text-2xl    justify-center  gap-2 w-[500px] shrink-0   items-center flex group  border-black rounded-full  group-hover:-translate-x-1 duration-300 group-hover:-translate-y-1 transition-transform">
