...
const Remarks = () => {
    return (
      ...
      <div className="w-full px-10 h-[700px] relative flex items-center justify-center">
            ...
             <div className="  pt-4 text-2xl h-[300px] font-semibold  justify-center  gap-2 bg-white   items-center flex group  border-black rounded-full  group-hover:-translate-x-1 duration-300 group-hover:-translate-y-1 transition-transform">
            “I launched MaxPacks as an experimental side gig; but within 2 years those Procreate brushes were earning more than my 6-figure salary in CG. Leaving in favor of Gumroad enabled me to explore other aspects of my art, develop new hobbies, and finally prioritize my personal life.”
             ...
             <div className="w-full md:h-[700px] relative flex items-center ">
            <Image src={"/max.webp"} alt="max image" fill className="object-contain lg:pt-3 flex z-10 "/>
            <Image src={"/writing.svg"} alt="max image" width={150} height={200} className="z-10 left-[90px] object-contain pt-[300px] flex md:absolute"/>
            <div className="absolute  group group-hover:translate-x-2 group-hover:translate-y-2 transition-transform flex items-center justify-center w-52 h-13 bg-black md:right-42 insert-0 bottom-[100px] lg:right-32 right-12 z-20 p-2 rounded-full">
